...
$columns = [
    ...
    "birth_date", "gender", "email", "car_license", "motorcycle_license",
...
if ($searchValue != '') {
    ...
    $searchQuery = " AND (
        ...
        car_license LIKE '%$searchValueEscaped%' OR 
        motorcycle_license LIKE '%$searchValueEscaped%'
    )";
}

// จำนวนทั้งหมดก่อนกรอง
$totalRecordsQuery = "SELECT COUNT(*) as total FROM drivers";
$totalRecordsResult = $conn->query($totalRecordsQuery);
$totalRecords = $totalRecordsResult->fetch_assoc()['total'];

// จำนวนทั้งหมดหลังกรอง
$totalFilteredQuery = "SELECT COUNT(*) as total FROM drivers WHERE 1=1 $searchQuery";
...
$sql = "SELECT * FROM drivers WHERE 1=1 $searchQuery
