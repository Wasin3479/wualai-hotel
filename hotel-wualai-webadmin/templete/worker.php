...
<th style="white-space: nowrap; text-align: center;">ประเภทพนักงาน</th>
...
<th style="white-space: nowrap; text-align: center;">ยี่ห้อรถ</th>
<th style="white-space: nowrap; text-align: center;">ทะเบียนรถ</th>
...
{ "data": "email" },
{ "data": "worker_type" },
{ "data": "individual_document" },
{ "data": "company_name" },
{ "data": "company_document" },
{ "data": "profile_picture" },
{ "data": "createAt" },
{ "data": "updateAt" },
{ "data": "workers_carbrand" },
{ "data": "workers_carlicense" },
            {
                "data": null,
                "orderable": false,
    ...
    $('#verifyForm').on('submit', function(e) {
        ...
        $.ajax({
            url: 'update_verify_workers.php',  // ไฟล์ PHP สำหรับอัพเดตข้อมูล
            method: 'POST',
            data: {
                id: userId,
                verify: verifyStatus
