...
$sql = "SELECT * FROM wallets_worker";
...
while($resultui=mysqli_fetch_array($queryui,MYSQLI_ASSOC))
{
    echo $resultui["first_name"];  echo " "; echo $resultui["last_name"];
          ...
          <td><?= htmlspecialchars($row['updated_at']) ?></td>
           <td><a href="https://panel.buntook.com/payment/index.php?codelist=<?= htmlspecialchars($row['worker_id']) ?>&type=<?php echo $strstatus;?>" class="btn btn-primary" target="_blank">เติมเงิน</a></td>
